...
public class geoFenceActivityBak extends AppCompatActivity
		implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnGetFence.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {

				//LatLng position = new LatLng(4.8992676,100.6603051);
				LatLng position = new LatLng(5.3296033,100.4893665);
		...
		btnAuth.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				sendPost(new DataListener() {
					@Override
					public void onDataReady(String data) {
						Log.i("Data syuks",data);
						...
						try {
							...
							JSONArray geodata = jsonResponse.getJSONArray("GEODATA");
	...
	private void writeActualLocation(Location location) {
		...
		//markerLocation(new LatLng(5.353058,100.307405));
	}
	...
	public void sendPost(final DataListener dataListener) {
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				try {
					...
					URL url = new URL("http://ge.smartlab.com.my/cloudtms/websvc/remote_check.asp");
